...
| **⚙️ 设置** | AI API 配置（Base URL/Key/模型）、数据导入/导出/重置 |
...
当前没有 npm/package 构建流程。数据层回归测试使用 Node.js 直接运行：
...
- `PRD_LifeOS_v1.md` — 完整产品需求文档（功能清单、验收标准、MoSCoW 优先级）
- `character_dialogue_styles.json` — 31 位核心角色的台词风格描述与示例台词

---

> 版本：v1.1-dev | 作者：Jasmine | 最后更新：【2026-07-08 10:53】
